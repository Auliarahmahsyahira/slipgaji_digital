...
return new class extends Migration
{
    ...
    public function up(): void { 
        Schema::create('detailpenghasilan', function (Blueprint $table) { $table->id('detail_penghasilan'); 
            ...
            $table->decimal('nominal', 15, 2)->default(0); $table->timestamps(); 
        });
    }
    ...
    {
        Schema::dropIfExists('detail_penghasilan');
    }
};
